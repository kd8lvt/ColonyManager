    ...
    internal class ManagerTab_Hunting : ManagerTab
    {
        ...
        public float DrawAnimalShortcuts(Vector2 pos, float width)
        {
            ...
            var exploding = animals
                .Where(a => a.RaceProps.DeathActionWorker.GetType() == typeof(DeathActionWorker_SmallExplosion)
                            || a.RaceProps.DeathActionWorker.GetType() == typeof(DeathActionWorker_BigExplosion))
                .ToList();
